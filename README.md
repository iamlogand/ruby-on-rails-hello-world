...
Ruby doesn't have an admin console. Coming from Django, it's difficult to imagine developing a serious web application without an admin console. However, there are probably plugins that solve this problem.
